...
@section('title', 'Add Mahasiswa')
    ...
    <form class="max-w-md mx-auto mt-16" action="{{ route('Create/Mahasiswa') }}" method="post">
     @csrf
     ...
     <div class="relative z-0 w-full mb-5 group">
         <input type="text" name="phone_number" id="phone" class="block py-2.5 px-0 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
